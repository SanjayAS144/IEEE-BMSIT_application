...
public class editprofileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Profile=findViewById(R.id.status_update);
        ...
        String status_value =getIntent().getStringExtra("name");
        Profile.setText(status_value);
        statusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                statusprogress= new ProgressDialog(editprofileActivity.this);
                ...
                mdatabase.child("name").setValue(updateprofile).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
